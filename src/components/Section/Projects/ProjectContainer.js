        ...
        data: [
            {
                ...
                txt: [
                    "문화정보원 기관의 국립중앙도서관, 국립어린이도서관, 제주국제공항, 국립제주박물관 4개 기관의 챗봇 API 구축과 모바일 큐아이 챗봇 화면 개발",
                ],
            ...
            },
            {
                ...
                txt: [
                    "비목추천 API를 활용한 챗봇 API 개발과 react.js를 사용한 챗봇 화면 개발",
                ],
            ...
            },
            {
                ...
                url: "https://qi.kcisa.kr/",
                txt: [
                    "문화정보원 기관의 국립태권도박물관, 국립아시아문화전당, 국립국악원 3개 기관의 챗봇 API 구축과 모바일 큐아이 챗봇 화면 개발",
                ],
            ...
            },
            {
                ...
                txt: [
                    "react.js를 활용한 웹앱 챗봇 화면 개발 및 스트레스 지수 파악 API 개발",
                ],
            ...
            },
            {
                ...
                txt: [
                    "React.js를 활용하여 각 메뉴마다 따로 프로세스를 구성하여 만든 개인 프로젝트",
                ],
                img: [PIMG],
